...
public class M_Problem_0542_01Matrix {
    ...
    // go from src.main.java.advanced.top-left to bottom-right, then from bottom-right to src.main.java.advanced.top-left
    public int[][] updateMatrix2(int[][] matrix) {
        int m = matrix.length, n = matrix[0].length;
        int t = m * n + 1; // distance cannot exceed m*n+1
        int[][] distance = new int[m][n];

        // from src.main.java.advanced.top-left to bottom-right
        ...
        // from bottom-right to src.main.java.advanced.top-left
