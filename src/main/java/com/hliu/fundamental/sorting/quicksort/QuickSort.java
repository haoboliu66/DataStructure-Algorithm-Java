package com.hliu.fundamental.sorting.quicksort;
...
public class QuickSort {
  ...
  /**
   * divide the array by num, numbers less or equal than num on the left side, numbers greater on the right side of the
   * array
   */
...
//        arr[index] = arr[index] ^ arr[i];
  ...
  /**
   * 荷兰国旗问题 divide the array by num, numbers less than num on the left side, numbers greater on the right side of the
   * array, equal in the middle
   */
  ...
  /**
   * 在left到right范围内进行荷兰国旗算法, 默认以arr[right]为pivot做partition, 返回相等区的两个边界index 荷兰国旗问题, 返回相等区两个边界
   */
  ...
  /**
   * quickSort1 quickSort2, time complexity: O(N^2) quickSort3  time complexity: O(N*logN)
   * <p>
   * balanced partition VS unbalanced partition quickSort3  probability and long-term expectation
   */
